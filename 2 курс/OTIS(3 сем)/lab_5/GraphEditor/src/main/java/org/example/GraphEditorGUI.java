...
public class GraphEditorGUI {
    ...
    public GraphEditorGUI() {
        ...
        JMenuItem saveMenuItem = new JMenuItem("Сохранить граф как файл");
        ...
        JMenuItem openMenuItem = new JMenuItem("Открыть файл");
        ...
        createGraphButton.setFont(new Font("Arial", Font.BOLD, 14));
        createGraphButton.setBackground(Color.LIGHT_GRAY);
        createGraphButton.setForeground(Color.BLACK);
        JPanel ButtonPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
        JMenu nodeMenu = new JMenu("Node Actions");
        nodeMenu.setForeground(Color.GRAY);
        //nodeActions
        JMenuItem addNodeMenuItem = new JMenuItem("Добавить узел");
        JMenuItem setNodeContentMenuItem = new JMenuItem("Добавить содержимое узла");
        JMenuItem getNodeContentMenuItem = new JMenuItem("Получить содержимое узла");
        JMenuItem delNodeContentMenuItem = new JMenuItem("Удалить содержимое узла");
        JMenuItem renameNodeMenuItem = new JMenuItem("Переименовать узел");
        JMenuItem setNodeColorItem = new JMenuItem("Устновить цвет узла");
        JMenuItem getNodeDegreeItem = new JMenuItem("Получить степень узла");
        JMenuItem removeNodeMenuItem = new JMenuItem("Удалить узел");
        JMenu edgeMenu = new JMenu("Edge Actions");
        edgeMenu.setForeground(Color.GRAY);
        //edgeActions
        JMenuItem addEdgeMenuItem = new JMenuItem("Добавить дугу");
        JMenuItem setEdgeColorItem = new JMenuItem("Установить цвет дуги");
        JMenuItem removeEdgeMenuItem = new JMenuItem("Удалить дугу");
        JMenu actionsMenu = new JMenu("Graph Actions");
        actionsMenu.setForeground(Color.BLACK);
        //graphActions
        JMenuItem findEulirianCycleItem = new JMenuItem("Найти Эйлеров цикл");
        JMenuItem findHamiltonCycleItem = new JMenuItem("Найти Гамильтонов цикл");
        JMenuItem findDiameterItem = new JMenuItem("Найти диаметр");
        JMenuItem findRadiusItem = new JMenuItem("Найти радиус");
        JMenuItem findCenterItem = new JMenuItem("Найти центр");
        JMenuItem findTensorProductItem = new JMenuItem("Тензорное произведение");
        JMenuItem findCartesianProductItem = new JMenuItem("Декартово произведение");
        JMenuItem createTreeGraphItem = new JMenuItem("Создать дерево");

        JButton visualizeGraphButton = new JButton("Показ графа");
        visualizeGraphButton.setBackground(Color.LIGHT_GRAY);
        visualizeGraphButton.setForeground(Color.BLACK);


        graphComboBox = new JComboBox<>();
        graphComboBox.addItem("Выберите граф");
        graphComboBox.setBackground(Color.LIGHT_GRAY);
        graphComboBox.setForeground(Color.BLACK);
        ...
        findTensorProductItem.addActionListener(e -> {
            ...
            if (firstGraph != null && secondGraph != null) {
                Graph tensorProductGraph = Graph.tensorProduct(firstGraph, secondGraph);
                graphs.add(tensorProductGraph);
                graphComboBox.addItem(tensorProductGraph.getName());
            } else {
                JOptionPane.showMessageDialog(frame, "No graph is selected. Create or select a graph first.");
            }
            updateGraphInformation();
        ...
        actionsMenu.add(findTensorProductItem);
